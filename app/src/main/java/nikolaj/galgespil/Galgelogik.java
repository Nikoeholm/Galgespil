...
/**
 * Logikken er hentet fra AndroidElementer lekt02_aktiviteter Galgelogik. Der er foretaget
 * justeringer i forhold til originalen.
 */

public class Galgelogik { private ArrayList<String> muligeOrd = new ArrayList<String>();
